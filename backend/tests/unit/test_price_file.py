...
class TestPriceFile:
    ...
    async def test_check_file_no_file(self, mock_tibber_get_prices):
        ...
        with (
            ...
            patch(
                "price_driven_switch.services.price_file.PriceFile._update_price_file"
            ) as mock_update,
        ):
    ...
    async def test_check_file_out_of_date(self, mock_tibber_get_prices):
        ...
        with (
            ...
            patch(
                "price_driven_switch.services.price_file.PriceFile._load_price_file",
                return_value=("2023-05-06 18:25", {}),
            ),
            patch(
                "price_driven_switch.services.price_file.PriceFile._write_prices_file"
            ) as mock_write,
        ):
            await price_file._check_file()
